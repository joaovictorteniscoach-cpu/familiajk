...
saibro=ROOT/'app-aluno/assets/jv-quadra-3d.webp'

print('== App Aluno premium')
ok(saibro.exists() and (ROOT/'app-gestao/assets/jv-quadra-3d.webp').exists(),'cada app inclui seu fundo no deploy independente')
ok("url('assets/jv-quadra-3d.webp')" in a,'Aluno usa a quadra de saibro renderizada (local)')
...
ok("url('../assets/jv-quadra-3d.webp')" in gc,'quadra de saibro renderizada no hero da Gestão')
