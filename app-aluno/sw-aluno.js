...
const V = '2026-09-25-8';
const CACHE = 'jvtenis-aluno-v17';
const SHELL = ['./', './manifest-aluno.webmanifest', './jv-icone-aluno.png', './jv-icone-aluno-180.png', '../assets/jv-saibro-premium.svg'];
