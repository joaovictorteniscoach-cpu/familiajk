...
const V = '2026-09-26-11';
const CACHE = 'jvtenis-aluno-v18';
const SHELL = ['./', './manifest-aluno.webmanifest', './jv-icone-aluno.png', './jv-icone-aluno-180.png', './assets/jv-topo-quadra.webp', './lib/jv-modelo.css?v='+V, './lib/icones.js?v='+V];
